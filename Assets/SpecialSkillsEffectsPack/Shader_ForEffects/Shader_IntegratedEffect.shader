		...
		Properties {
			[Header(Main)]
				[Space]
					...
					[Toggle(IS_TEXTURE_ANIMATE_ADVANCED)]_TextureAnimateAdvanced("Is Texture Animate Advanced",int) = 0
						_MaxIndex("Texture Blend Count",int) = 2
